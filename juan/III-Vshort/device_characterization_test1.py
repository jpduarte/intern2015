...
M1.updateparameter('plot_macro',['35fet_GF2_FetPS_10'])#width,35fet_GF2_FetPS_10
...
M1.updateparameter('xlogflag' , 0)
M1.updateparameter('color' , 'y')
M1.plotcharacterization(8,'Ionmax','Leff','@T=300K')

M1.updateparameter('plot_characterization_save' , 1)
M1.updateparameter('plot_characterization_file_out' , '/home/juan/research/intern/SC_III-V/'+'300K_Ronmax_vs_Leff.txt')
