...
for current in currents:
  ...
  for filename in filesdata:
    ...
    M1.updateparameter('plot_macro',['NPN_M1'])#width,35fet_GF2_FetPS_10
    M1.updateparameter('plot_device',['FET5_5x0.08_NPN_M1_CAoverPC'] )#->gate length ['1.0x0.08_P']  ['FET3_5x0.1_NPN_M1']1.0x0.08_P
...
ax = plt.gca()
plt.title(M1.plot_macro[0]+', FET L=0.08, W=5')
ax.set_ylabel(currents[0]+'/um (A/um)')
plt.savefig('Temp_lin_'+ M1.plot_macro[0]+'_5'+currents[0], bbox_inches='tight')
...
plt.title(M1.plot_macro[0]+', FET L=0.08, W=5')
ax.set_ylabel(currents[0]+'/um (A/um)')
plt.savefig('Temp_log_'+ M1.plot_macro[0]+'_5'+currents[0], bbox_inches='tight')
