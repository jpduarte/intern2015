...
for current in currents:
  ...
  for filename in filesdata:
    ...
    M1.updateparameter('plot_macro',['COLADA_JTK_Device2P'])#width,35fet_GF2_FetPS_10
    M1.updateparameter('plot_device',['1.0x0.08_P'] )#->gate length ['1.0x0.08_P']  ['FET3_5x0.1_NPN_M1']1.0x0.08_P
...
ax = plt.gca()
plt.title('COLADA_JTK_Device2P, FET L=0.08, W=1')
ax.set_ylabel('Ig/um (A/um)')
plt.savefig('Temp_log_COLADA_JTK_Device2P_Ig', bbox_inches='tight')
plt.show() 
